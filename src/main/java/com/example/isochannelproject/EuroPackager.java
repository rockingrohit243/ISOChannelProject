...
import org.jpos.iso.IFEP_LLLCHAR;
...
public class EuroPackager extends ISOBasePackager {
    ...
    /*048*/ new IFA_LLLNUM (999, "RESERVED PRIVATE"),
//    /*048*/ new ISOMsgFieldPackager(
//            new IFA_LLLCHAR(999, "EUROPAY FIELD 48"),
//            f48Packager
//        ),
    ...
    /*055*/ new IFA_LLLBINARY(999, "RESERVED ISO"),//binary variable was IFA_LLLCHAR
    ...
    /*061*/ new IFA_LLLNUM (999, "RESERVED PRIVATE"),
    ...
    protected static class Euro48Packager extends EuroSubFieldPackager
    {
    	...
    	private ISOFieldPackager fld48[] =
            {
                new IF_CHAR     (15,  "PLACEHOLDER"),
                new IF_CHAR     (18,  "PLACEHOLDER"),
                new IFEP_LLCHAR  (15, "Field 48 - PDS01"),
                ...
                new IFEP_LLCHAR  (0,  ""),
                new IFEP_LLCHAR  (0,  ""),
                new IFEP_LLLCHAR  (0,  "Field 48 - PDS50"),
                new IFEP_LLLCHAR (5,  "Field 48 - PDS51"),
                new IFEP_LLCHAR  (0,  ""),
                new IFEP_LLCHAR  (0,  ""),
                new IFEP_LLCHAR  (1,  "Field 48 - PDS54"),
                new IFEP_LLCHAR  (0,  ""),
                new IFEP_LLCHAR  (0,  ""),
                new IFEP_LLCHAR  (0,  ""),
                new IFEP_LLCHAR  (0,  ""),
